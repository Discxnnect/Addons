...
local ThemeManager = {} do
	ThemeManager.Folder = 'Remixs Hub Premium'
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"c4ec84","MainColor":"0a0a0a","AccentColor":"c4ec84","BackgroundColor":"000000","OutlineColor":"0f0f0f"}') },
	...
	function ThemeManager:LoadDefault()		
		local theme = 'Default'
		local content = isfile(self.Folder .. '/Custom-Themes/Default.config') and readfile(self.Folder .. '/Custom-Themes/Default.config')
	...
	function ThemeManager:SaveDefault(theme)
		writefile(self.Folder .. '/Custom-Themes/Default.config', theme)
	end
	...
	function ThemeManager:GetCustomTheme(file)
		local path = self.Folder .. '/Custom-Themes/' .. file
	...
	function ThemeManager:SaveCustomTheme(file)
		...
		writefile(self.Folder .. '/Custom-Themes/' .. file .. '.config', httpService:JSONEncode(theme))
	end

	function ThemeManager:ReloadCustomThemes()
		local list = listfiles(self.Folder .. '/Custom-Themes')

		local out = {}
		for i = 1, #list do
			local file = list[i]
			if file:sub(-5) == '.config' then
				-- i hate this but it has to be done ...

				local pos = file:find('.config', 1, true)
	...
	function ThemeManager:BuildFolderTree()
		...
		table.insert(paths, self.Folder .. '/Custom-Themes')
		table.insert(paths, self.Folder .. '/Custom-Settings')
